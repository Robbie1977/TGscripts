...
Lfile = '../template/flyVNCtemplate8.marker'

outdir = './'

fo = open("FLrigidPS.txt",'r')
    ...
    if (hostn + '\n') in stoplist:
        ...
        try:
            if os.path.exists(fname):
                os.rename(fname,fname.replace('rigid_ps.raw','rigid_ps-l.raw'))
                ...
                FloatFile = fname.replace('rigid_ps.raw','rigid_ps-l.raw')
                Lxoutput = outdir + basename + '-local_m8.raw'
