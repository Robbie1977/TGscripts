...
Tfile = '../template/flyVNCtemplate20x.nrrd'
outdir = './'

fo = open("FLwarpR.txt",'r')
            ...
            if os.path.exists(fname):
                ...
                if os.path.exists(W5xform): 
                    ...
                    if os.path.exists(W5xform):
                        ...
                        return_code = subprocess.call('nice ' + cmtkdir + 'warp -o %s --grid-spacing 80 --exploration 30 --coarsest 4 --accuracy 0.2 --refine 4 --energy-weight 1e-1 %s %s' % (W5xform + '_part', Tfile, FloatFile), shell=True) #coarsest adjusted from 8 to 4 as per greg sug.
